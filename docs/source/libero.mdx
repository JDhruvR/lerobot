# LIBERO
 NOTE: PLEASE REINSTALL THE ENTIRE LEROBOT ENV AS I OVER-WROTE IT AND INSTALLED RANDOM TRASH AND DIFFERENT LIBERO. PLEASE TAKE CARE OF THAT BEFORE RUNNING AGAIN
